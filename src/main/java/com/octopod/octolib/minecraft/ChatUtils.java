...
public class ChatUtils {
	...
	*/
    ...
    static public List<ChatElement> blockElement(ChatElement element, int toWidth, int alignment) {
    	return blockElement(element, toWidth, alignment, ' ', true);
    }   
    
    static public List<ChatElement> blockElement(ChatElement element, int toWidth, int alignment, char fillerChar, boolean precise){

        return block(toLegacy(element), toWidth, alignment, fillerChar, precise, new BlockRenderer<List<ChatElement>>() {
