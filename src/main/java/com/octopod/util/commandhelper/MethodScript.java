...
public class MethodScript
{
	 ...
	 */
	public static CompiledMethodScript compile(String script) throws ConfigCompileException, ConfigCompileGroupException
	{
		return new CompiledMethodScript(script);
	}

	public static ParseTree compileParseTree(String script) throws ConfigCompileException, ConfigCompileGroupException
	{
	 ...
	 * @throws ConfigCompileGroupException
	 */
	public static CompiledMethodScript compile(String script, Environment env) throws ConfigCompileException, ConfigCompileGroupException
	{
		return new CompiledMethodScript(script, null, env);
	}
	...
	{
		return new Procedure(name, CClassType.AUTO, vars, compileParseTree(script), Target.UNKNOWN);
	}
